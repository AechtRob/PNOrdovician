...
public class GenLayerDiversifyOceanOrdovician extends GenLayer {
    ...
    private final int OrdovicianBiomes[] = new int[] {
            ...
            ORDOVICIAN_OCEAN_ID,
            ORDOVICIAN_OCEAN_ID,
            ORDOVICIAN_ALGAL_REEF_ID,
            ORDOVICIAN_BRYOZOAN_REEF_ID,
            ORDOVICIAN_SPONGE_ID
    };
    ...
    private final int OrdovicianBiomesFrozen[] = new int[] {
            ...
            ORDOVICIAN_OCEAN_FROZEN_ID,
            ORDOVICIAN_OCEAN_FROZEN_ID,
            ORDOVICIAN_OCEAN_ICEBERGS_ID
    };

    public GenLayerDiversifyOceanOrdovician(long seed, GenLayer genlayer) {
        super(seed);
