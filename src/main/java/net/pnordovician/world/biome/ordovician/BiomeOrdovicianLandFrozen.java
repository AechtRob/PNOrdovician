...
public class BiomeOrdovicianLandFrozen extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:ordovician_land_frozen")
	public static final BiomeGenCustom biome = null;
	public BiomeOrdovicianLandFrozen(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeOrdovician {
		public BiomeGenCustom() {
			super(new BiomeProperties("Ordovician Frozen Land").setRainfall(0.5F).setBaseHeight(0.0F).setHeightVariation(0.0F).setTemperature(-1.8F).setSnowEnabled());
			setRegistryName("lepidodendron:ordovician_land_frozen");
