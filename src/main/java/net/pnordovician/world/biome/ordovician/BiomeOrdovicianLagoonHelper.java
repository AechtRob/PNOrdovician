...
public class BiomeOrdovicianLagoonHelper extends ElementsLepidodendronMod.ModElement {
	...
	public BiomeOrdovicianLagoonHelper(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeOrdovician {
		public BiomeGenCustom() {
			super(new BiomeProperties("Ordovician Lagoons").setRainfall(0.9F).setBaseHeight(0.065F).setHeightVariation(0.0F).setTemperature(0.9F));
