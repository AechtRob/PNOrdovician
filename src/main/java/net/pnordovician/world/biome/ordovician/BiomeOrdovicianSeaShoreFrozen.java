...
public class BiomeOrdovicianSeaShoreFrozen extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:ordovician_sea_shore_frozen")
	public static final BiomeGenCustom biome = null;
	public BiomeOrdovicianSeaShoreFrozen(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeOrdovician {
		public BiomeGenCustom() {
			super(new BiomeProperties("Ordovician Frozen Shallow Ocean").setRainfall(0.5F).setBaseHeight(-0.65F).setHeightVariation(0.01F).setTemperature(-1.8F).setSnowEnabled());
			setRegistryName("lepidodendron:ordovician_sea_shore_frozen");
