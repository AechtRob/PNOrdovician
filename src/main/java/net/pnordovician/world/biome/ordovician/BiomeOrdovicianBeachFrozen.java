...
public class BiomeOrdovicianBeachFrozen extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:ordovician_beach_frozen")
	public static final BiomeGenCustom biome = null;
	public BiomeOrdovicianBeachFrozen(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeOrdovician {
		public BiomeGenCustom() {
			super(new BiomeProperties("Ordovician Frozen Beach").setRainfall(0.5F).setBaseHeight(0.0F).setHeightVariation(0.025F).setTemperature(-1.8F).setSnowEnabled());
			setRegistryName("lepidodendron:ordovician_beach_frozen");
