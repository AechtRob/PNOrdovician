...
public class BiomeOrdovicianBeach extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:ordovician_beach")
	public static final BiomeGenCustom biome = null;
	public BiomeOrdovicianBeach(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeOrdovician {
		public BiomeGenCustom() {
			super(new BiomeProperties("Ordovician Beach").setRainfall(0.5F).setBaseHeight(0.0F).setHeightVariation(0.025F).setTemperature(0.5F));
			setRegistryName("lepidodendron:ordovician_beach");
