...
public class BiomeOrdovicianSeaIce extends ElementsLepidodendronMod.ModElement {
	...
	static class BiomeGenCustom extends BiomeOrdovician {
		public BiomeGenCustom() {
			super(new BiomeProperties("Ordovician Frozen Ocean").setRainfall(0.5F).setBaseHeight(-1.15F).setHeightVariation(0.05F).setTemperature(-1.8F).setSnowEnabled());
			setRegistryName("lepidodendron:ordovician_sea_ice");
