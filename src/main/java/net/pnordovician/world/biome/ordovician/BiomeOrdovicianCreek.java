...
public class BiomeOrdovicianCreek extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:ordovician_creek")
	public static final BiomeGenCustom biome = null;
	public BiomeOrdovicianCreek(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeOrdovician {
		public BiomeGenCustom() {
			super(new BiomeProperties("Ordovician Creek").setRainfall(0.5F).setBaseHeight(-0.525F).setHeightVariation(0.0F).setTemperature(0.5F));
			setRegistryName("lepidodendron:ordovician_creek");
