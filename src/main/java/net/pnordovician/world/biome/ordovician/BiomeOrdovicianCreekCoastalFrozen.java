...
public class BiomeOrdovicianCreekCoastalFrozen extends ElementsLepidodendronMod.ModElement {
	...
	public BiomeOrdovicianCreekCoastalFrozen(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeOrdovician {
		public BiomeGenCustom() {
			super(new BiomeProperties("Ordovician Frozen Coastal Creek").setRainfall(0.5F).setBaseHeight(-0.525F).setHeightVariation(0.0F).setTemperature(-1.8F).setSnowEnabled());
