...
public class BiomeOrdovicianCreekCoastal extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:ordovician_creek_coastal")
	public static final BiomeGenCustom biome = null;
	public BiomeOrdovicianCreekCoastal(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeOrdovician {
		public BiomeGenCustom() {
			super(new BiomeProperties("Ordovician Coastal Creek").setRainfall(0.5F).setBaseHeight(-0.525F).setHeightVariation(0.0F).setTemperature(0.5F));
			setRegistryName("lepidodendron:ordovician_creek_coastal");
