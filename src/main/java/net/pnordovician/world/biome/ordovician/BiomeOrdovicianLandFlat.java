...
public class BiomeOrdovicianLandFlat extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:ordovician_land_flat")
	public static final BiomeGenCustom biome = null;
	public BiomeOrdovicianLandFlat(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeOrdovician {
		public BiomeGenCustom() {
			super(new BiomeProperties("Ordovician Barren Land").setRainfall(0.5F).setBaseHeight(0.0F).setHeightVariation(0.0F).setTemperature(0.5F));
			setRegistryName("lepidodendron:ordovician_land_flat");
