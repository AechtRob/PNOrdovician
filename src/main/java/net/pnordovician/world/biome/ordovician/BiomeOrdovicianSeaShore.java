...
public class BiomeOrdovicianSeaShore extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:ordovician_sea_shore")
	public static final BiomeGenCustom biome = null;
	public BiomeOrdovicianSeaShore(ElementsLepidodendronMod instance) {
		super(instance, 1591);
	}
	...
	static class BiomeGenCustom extends BiomeOrdovician {
		public BiomeGenCustom() {
			super(new BiomeProperties("Ordovician Shallow Ocean").setRainfall(0.5F).setBaseHeight(-0.65F).setHeightVariation(0.01F).setTemperature(0.5F));
			setRegistryName("lepidodendron:ordovician_sea_shore");
